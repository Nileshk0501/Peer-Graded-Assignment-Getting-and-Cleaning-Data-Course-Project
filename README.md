...
The run_analysis.R can be run as long as setting your working directory to the UCI HAR Dataset folder that is obtained by downloading the zip file through above link. Dplyr package was required to run this script.
